...
exports.interpretSearchPhrase = functions
  .runWith({ timeoutSeconds: 30, memory: "256MB" }) // ⚙️ Recursos ligeros pero suficientes
  .region("us-central1") // ✅ Evita migración forzada
